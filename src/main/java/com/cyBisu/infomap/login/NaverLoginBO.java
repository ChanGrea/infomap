package com.cyBisu.infomap.login;
...
public class NaverLoginBO {
    ...
    private final static String CLIENT_ID = "ZZmcSfcMoCEqcOkpk0qO";       //네이버API Client ID
    private final static String CLIENT_SECRET = "1ntG9b2rj1";
